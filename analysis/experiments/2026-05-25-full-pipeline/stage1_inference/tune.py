"""Stage 1: tune (tau_prior, epsilon, memory_strategy) on the full 5-export dataset.

Human-only, clean-teams-only. Objective: per-query mean log-likelihood of
the human's inferred role under the marginal of the Bayesian posterior at
inference time.
"""
...
def main():
    print("=" * 66)
    print("Stage 1 (5 exports, human-only, clean teams): inference tuning")
    print("=" * 66)
